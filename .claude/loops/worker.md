...
- **Birth/death are LLM-routed.** Skill prose at `dna/specials/mother/.pi/skills/birth/SKILL.md` and `dna/specials/mother/.pi/prompts/cell-destroy.md` is the source of truth. Don't migrate steps into deterministic TS to "speed things up" — iterate on the skill.
