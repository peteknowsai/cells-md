...
- `mv dna/cells/base/bin/cells dna/cells/base/bin/<namespace>`
...
Both CLIs (`cli/<ns>.ts` on Mac, `dna/cells/base/bin/<ns>` on each well)
...
- `dna/cells/base/bin/<ns>`: same translation. `cells list` filters API
